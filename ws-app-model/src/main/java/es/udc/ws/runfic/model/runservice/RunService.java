...
public interface RunService {
    ...
    public Race addRace(String city, String description, LocalDateTime startDateTime, BigDecimal price, int maxParticipants)
    ...
    public void getRunnerNumber(String email, int inscriptionID, String creditCardNumber) throws InputValidationException,
